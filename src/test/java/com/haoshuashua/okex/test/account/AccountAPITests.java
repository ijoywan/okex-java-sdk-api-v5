package com.haoshuashua.okex.test.account;

import com.alibaba.fastjson.JSONObject;
import com.haoshuashua.okex.bean.account.param.IncreaseDecreaseMargin;
import com.haoshuashua.okex.bean.account.param.SetLeverage;
import com.haoshuashua.okex.bean.account.param.SetPositionMode;
import com.haoshuashua.okex.bean.account.param.SetTheDisplayTypeOfGreeks;
import com.haoshuashua.okex.service.account.AccountAPIService;
import com.haoshuashua.okex.service.account.impl.AccountAPIServiceImpl;
...
//        setLeverage.setCcy("");
    ...
    public void getMaximumTradableSizeForInstrument(){
        JSONObject result = this.accountAPIService.getMaximumTradableSizeForInstrument("DOGE-USDT","cross","DOGE","");
        toResultString(LOG, "result", result);
    }
