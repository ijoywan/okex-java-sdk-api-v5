package com.haoshuashua.okex.test.ws.privateChannel;


import com.haoshuashua.okex.test.ws.privateChannel.config.WebSocketClient;
import com.haoshuashua.okex.test.ws.privateChannel.config.WebSocketConfig;
...
public class PrivateChannelTest {
    ...
    public void privatePositionsChannel() {
        ...
        positionsMap.put("uly","DOGE-USDT");
        positionsMap.put("instId","DOGE-USDT-SWAP");
