package com.haoshuashua.okex.test.publicData;


import com.alibaba.fastjson.JSONObject;
import com.haoshuashua.okex.service.publicData.PublicDataAPIService;
import com.haoshuashua.okex.service.publicData.impl.PublicDataAPIServiceImpl;
...
public class PublicDataAPITest extends BaseTests {
    ...
    public void getOpenInterest(){
        JSONObject result = publicDataAPIService.getOpenInterest("SWAP","DOGE-USDT","DOGE-USDT-SWAP");
        toResultString(LOG, "result", result);
    }
